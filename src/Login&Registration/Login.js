    ...
    <div className='flex justify-center'>
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-[#CCF2F4] text-black ">
        ...
        <form className="space-y-6">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-end text-xs dark:text-gray-400">
              <Link to="#" className="link link-hover text-[#579BB1] font-semibold">Forgot Password?</Link>
            </div>
          </div>
        ...
        <p className="text-base text-center sm:px-6 dark:text-gray-400">Don't have an account?
          <Link to='/register' className="link link-hover text-[#579BB1] font-semibold">Sign up</Link>
        </p>
      </div>
    </div>
  );
